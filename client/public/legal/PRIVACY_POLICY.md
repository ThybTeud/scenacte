...
Les données sont hébergées par **Render.com** (région Frankfurt, UE).
Les sauvegardes chiffrées peuvent être transférées aux États-Unis, encadrées par les Clauses Contractuelles Types.

## 5. Vos droits (RGPD)

Vous pouvez exercer vos droits d'accès, rectification, effacement, portabilité, opposition et limitation en écrivant à : contact@scenacte.fr
