...
export function EditorPreviewPanel({
  ...
  // Si un scrollContainerRef externe est fourni, on l'utilise ; sinon le local
  const resolvedScrollRef = scrollContainerRef ?? localScrollRef;
  ...
  return (
    <div className="hidden md:flex md:flex-col flex-1 min-w-0 max-w-lg h-full overflow-hidden border-l-2 border-border">
      ...
      <div ref={resolvedScrollRef} className="overflow-auto flex-1 bg-white">
