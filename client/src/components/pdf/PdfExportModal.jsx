        ...
        <Modal isOpen={isOpen} onClose={onClose} title="Export PDF" size="full">
            <div className="flex h-full gap-4">
                ...
                <div className="w-64 flex-shrink-0 border-r-2 border-black pr-4">
                    ...
                    {/* Footer avec actions */}
                    <div className="flex justify-between gap-3 mt-4 pt-4 border-t-2 border-black">
                        ...
                        <PDFDownloadLink
                            ...
                            className="inline-flex gap-2 px-4 py-2 font-ui font-medium text-white bg-violet border-2 border-black rounded shadow-brutal hover:shadow-brutal-hover transition-shadow"
                        >
                            {({ loading, error }) => {
                                if (loading) {
                                    return (
...
function getTemplateDescription(template) {
    const descriptions = {
        classic:
            "Style traditionnel avec police Serif, idéal pour l'impression.",
